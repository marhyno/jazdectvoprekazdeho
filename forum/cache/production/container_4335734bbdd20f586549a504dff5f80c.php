...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000648cb78f000000005403f06e(
...
class phpbbtemplatetwiglexer_00000000648cb78f000000005403f06e extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5c228f72a930c818072572 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5c228f72a9316357191810 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5c228f72a92e9022432624 = array(
    ...
    {
        $this->initializer5c228f72a9316357191810 && ($this->initializer5c228f72a9316357191810->__invoke($valueHolder5c228f72a930c818072572, $this, 'set_environment', array('env' => $env), $this->initializer5c228f72a9316357191810) || 1) && $this->valueHolder5c228f72a930c818072572 = $valueHolder5c228f72a930c818072572;

        return $this->valueHolder5c228f72a930c818072572->set_environment($env);
    }
    ...
    {
        $this->initializer5c228f72a9316357191810 && ($this->initializer5c228f72a9316357191810->__invoke($valueHolder5c228f72a930c818072572, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5c228f72a9316357191810) || 1) && $this->valueHolder5c228f72a930c818072572 = $valueHolder5c228f72a930c818072572;

        return $this->valueHolder5c228f72a930c818072572->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5c228f72a9316357191810 && ($this->initializer5c228f72a9316357191810->__invoke($valueHolder5c228f72a930c818072572, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5c228f72a9316357191810) || 1) && $this->valueHolder5c228f72a930c818072572 = $valueHolder5c228f72a930c818072572;

        return $this->valueHolder5c228f72a930c818072572->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5c228f72a9316357191810 = $initializer;
    }
    ...
    {
        $this->initializer5c228f72a9316357191810 && ($this->initializer5c228f72a9316357191810->__invoke($valueHolder5c228f72a930c818072572, $this, '__get', array('name' => $name), $this->initializer5c228f72a9316357191810) || 1) && $this->valueHolder5c228f72a930c818072572 = $valueHolder5c228f72a930c818072572;

        if (isset(self::$publicProperties5c228f72a92e9022432624[$name])) {
            return $this->valueHolder5c228f72a930c818072572->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c228f72a930c818072572;
    ...
    {
        $this->initializer5c228f72a9316357191810 && ($this->initializer5c228f72a9316357191810->__invoke($valueHolder5c228f72a930c818072572, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5c228f72a9316357191810) || 1) && $this->valueHolder5c228f72a930c818072572 = $valueHolder5c228f72a930c818072572;
    ...
    {
        $this->initializer5c228f72a9316357191810 && ($this->initializer5c228f72a9316357191810->__invoke($valueHolder5c228f72a930c818072572, $this, '__isset', array('name' => $name), $this->initializer5c228f72a9316357191810) || 1) && $this->valueHolder5c228f72a930c818072572 = $valueHolder5c228f72a930c818072572;
    ...
    {
        $this->initializer5c228f72a9316357191810 && ($this->initializer5c228f72a9316357191810->__invoke($valueHolder5c228f72a930c818072572, $this, '__unset', array('name' => $name), $this->initializer5c228f72a9316357191810) || 1) && $this->valueHolder5c228f72a930c818072572 = $valueHolder5c228f72a930c818072572;
    ...
    {
        $this->initializer5c228f72a9316357191810 && ($this->initializer5c228f72a9316357191810->__invoke($valueHolder5c228f72a930c818072572, $this, '__clone', array(), $this->initializer5c228f72a9316357191810) || 1) && $this->valueHolder5c228f72a930c818072572 = $valueHolder5c228f72a930c818072572;

        $this->valueHolder5c228f72a930c818072572 = clone $this->valueHolder5c228f72a930c818072572;
    }

    public function __sleep()
    {
        $this->initializer5c228f72a9316357191810 && ($this->initializer5c228f72a9316357191810->__invoke($valueHolder5c228f72a930c818072572, $this, '__sleep', array(), $this->initializer5c228f72a9316357191810) || 1) && $this->valueHolder5c228f72a930c818072572 = $valueHolder5c228f72a930c818072572;

        return array('valueHolder5c228f72a930c818072572');
    }
    ...
    {
        return $this->initializer5c228f72a9316357191810;
    }
    ...
    {
        return $this->initializer5c228f72a9316357191810 && ($this->initializer5c228f72a9316357191810->__invoke($valueHolder5c228f72a930c818072572, $this, 'initializeProxy', array(), $this->initializer5c228f72a9316357191810) || 1) && $this->valueHolder5c228f72a930c818072572 = $valueHolder5c228f72a930c818072572;
    }
    ...
    {
        return null !== $this->valueHolder5c228f72a930c818072572;
    }
    ...
    {
        return $this->valueHolder5c228f72a930c818072572;
    }
