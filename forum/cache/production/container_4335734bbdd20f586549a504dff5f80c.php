...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000649a635a000000007a25dacf(
...
class phpbbtemplatetwiglexer_00000000649a635a000000007a25dacf extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5c216d81baeb5090752170 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5c216d81baebf002337537 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5c216d81bae93831587793 = array(
    ...
    {
        $this->initializer5c216d81baebf002337537 && ($this->initializer5c216d81baebf002337537->__invoke($valueHolder5c216d81baeb5090752170, $this, 'set_environment', array('env' => $env), $this->initializer5c216d81baebf002337537) || 1) && $this->valueHolder5c216d81baeb5090752170 = $valueHolder5c216d81baeb5090752170;

        return $this->valueHolder5c216d81baeb5090752170->set_environment($env);
    }
    ...
    {
        $this->initializer5c216d81baebf002337537 && ($this->initializer5c216d81baebf002337537->__invoke($valueHolder5c216d81baeb5090752170, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5c216d81baebf002337537) || 1) && $this->valueHolder5c216d81baeb5090752170 = $valueHolder5c216d81baeb5090752170;

        return $this->valueHolder5c216d81baeb5090752170->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5c216d81baebf002337537 && ($this->initializer5c216d81baebf002337537->__invoke($valueHolder5c216d81baeb5090752170, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5c216d81baebf002337537) || 1) && $this->valueHolder5c216d81baeb5090752170 = $valueHolder5c216d81baeb5090752170;

        return $this->valueHolder5c216d81baeb5090752170->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5c216d81baebf002337537 = $initializer;
    }
    ...
    {
        $this->initializer5c216d81baebf002337537 && ($this->initializer5c216d81baebf002337537->__invoke($valueHolder5c216d81baeb5090752170, $this, '__get', array('name' => $name), $this->initializer5c216d81baebf002337537) || 1) && $this->valueHolder5c216d81baeb5090752170 = $valueHolder5c216d81baeb5090752170;

        if (isset(self::$publicProperties5c216d81bae93831587793[$name])) {
            return $this->valueHolder5c216d81baeb5090752170->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c216d81baeb5090752170;
    ...
    {
        $this->initializer5c216d81baebf002337537 && ($this->initializer5c216d81baebf002337537->__invoke($valueHolder5c216d81baeb5090752170, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5c216d81baebf002337537) || 1) && $this->valueHolder5c216d81baeb5090752170 = $valueHolder5c216d81baeb5090752170;
    ...
    {
        $this->initializer5c216d81baebf002337537 && ($this->initializer5c216d81baebf002337537->__invoke($valueHolder5c216d81baeb5090752170, $this, '__isset', array('name' => $name), $this->initializer5c216d81baebf002337537) || 1) && $this->valueHolder5c216d81baeb5090752170 = $valueHolder5c216d81baeb5090752170;
    ...
    {
        $this->initializer5c216d81baebf002337537 && ($this->initializer5c216d81baebf002337537->__invoke($valueHolder5c216d81baeb5090752170, $this, '__unset', array('name' => $name), $this->initializer5c216d81baebf002337537) || 1) && $this->valueHolder5c216d81baeb5090752170 = $valueHolder5c216d81baeb5090752170;
    ...
    {
        $this->initializer5c216d81baebf002337537 && ($this->initializer5c216d81baebf002337537->__invoke($valueHolder5c216d81baeb5090752170, $this, '__clone', array(), $this->initializer5c216d81baebf002337537) || 1) && $this->valueHolder5c216d81baeb5090752170 = $valueHolder5c216d81baeb5090752170;

        $this->valueHolder5c216d81baeb5090752170 = clone $this->valueHolder5c216d81baeb5090752170;
    }

    public function __sleep()
    {
        $this->initializer5c216d81baebf002337537 && ($this->initializer5c216d81baebf002337537->__invoke($valueHolder5c216d81baeb5090752170, $this, '__sleep', array(), $this->initializer5c216d81baebf002337537) || 1) && $this->valueHolder5c216d81baeb5090752170 = $valueHolder5c216d81baeb5090752170;

        return array('valueHolder5c216d81baeb5090752170');
    }
    ...
    {
        return $this->initializer5c216d81baebf002337537;
    }
    ...
    {
        return $this->initializer5c216d81baebf002337537 && ($this->initializer5c216d81baebf002337537->__invoke($valueHolder5c216d81baeb5090752170, $this, 'initializeProxy', array(), $this->initializer5c216d81baebf002337537) || 1) && $this->valueHolder5c216d81baeb5090752170 = $valueHolder5c216d81baeb5090752170;
    }
    ...
    {
        return null !== $this->valueHolder5c216d81baeb5090752170;
    }
    ...
    {
        return $this->valueHolder5c216d81baeb5090752170;
    }
