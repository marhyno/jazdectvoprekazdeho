...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000007ac755ab0000000068f9c9b9(
...
class phpbbtemplatetwiglexer_000000007ac755ab0000000068f9c9b9 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5c22bb92c81ca408061144 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5c22bb92c81d5190098851 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5c22bb92c81a6304442254 = array(
    ...
    {
        $this->initializer5c22bb92c81d5190098851 && ($this->initializer5c22bb92c81d5190098851->__invoke($valueHolder5c22bb92c81ca408061144, $this, 'set_environment', array('env' => $env), $this->initializer5c22bb92c81d5190098851) || 1) && $this->valueHolder5c22bb92c81ca408061144 = $valueHolder5c22bb92c81ca408061144;

        return $this->valueHolder5c22bb92c81ca408061144->set_environment($env);
    }
    ...
    {
        $this->initializer5c22bb92c81d5190098851 && ($this->initializer5c22bb92c81d5190098851->__invoke($valueHolder5c22bb92c81ca408061144, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5c22bb92c81d5190098851) || 1) && $this->valueHolder5c22bb92c81ca408061144 = $valueHolder5c22bb92c81ca408061144;

        return $this->valueHolder5c22bb92c81ca408061144->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5c22bb92c81d5190098851 && ($this->initializer5c22bb92c81d5190098851->__invoke($valueHolder5c22bb92c81ca408061144, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5c22bb92c81d5190098851) || 1) && $this->valueHolder5c22bb92c81ca408061144 = $valueHolder5c22bb92c81ca408061144;

        return $this->valueHolder5c22bb92c81ca408061144->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5c22bb92c81d5190098851 = $initializer;
    }
    ...
    {
        $this->initializer5c22bb92c81d5190098851 && ($this->initializer5c22bb92c81d5190098851->__invoke($valueHolder5c22bb92c81ca408061144, $this, '__get', array('name' => $name), $this->initializer5c22bb92c81d5190098851) || 1) && $this->valueHolder5c22bb92c81ca408061144 = $valueHolder5c22bb92c81ca408061144;

        if (isset(self::$publicProperties5c22bb92c81a6304442254[$name])) {
            return $this->valueHolder5c22bb92c81ca408061144->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c22bb92c81ca408061144;
    ...
    {
        $this->initializer5c22bb92c81d5190098851 && ($this->initializer5c22bb92c81d5190098851->__invoke($valueHolder5c22bb92c81ca408061144, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5c22bb92c81d5190098851) || 1) && $this->valueHolder5c22bb92c81ca408061144 = $valueHolder5c22bb92c81ca408061144;
    ...
    {
        $this->initializer5c22bb92c81d5190098851 && ($this->initializer5c22bb92c81d5190098851->__invoke($valueHolder5c22bb92c81ca408061144, $this, '__isset', array('name' => $name), $this->initializer5c22bb92c81d5190098851) || 1) && $this->valueHolder5c22bb92c81ca408061144 = $valueHolder5c22bb92c81ca408061144;
    ...
    {
        $this->initializer5c22bb92c81d5190098851 && ($this->initializer5c22bb92c81d5190098851->__invoke($valueHolder5c22bb92c81ca408061144, $this, '__unset', array('name' => $name), $this->initializer5c22bb92c81d5190098851) || 1) && $this->valueHolder5c22bb92c81ca408061144 = $valueHolder5c22bb92c81ca408061144;
    ...
    {
        $this->initializer5c22bb92c81d5190098851 && ($this->initializer5c22bb92c81d5190098851->__invoke($valueHolder5c22bb92c81ca408061144, $this, '__clone', array(), $this->initializer5c22bb92c81d5190098851) || 1) && $this->valueHolder5c22bb92c81ca408061144 = $valueHolder5c22bb92c81ca408061144;

        $this->valueHolder5c22bb92c81ca408061144 = clone $this->valueHolder5c22bb92c81ca408061144;
    }

    public function __sleep()
    {
        $this->initializer5c22bb92c81d5190098851 && ($this->initializer5c22bb92c81d5190098851->__invoke($valueHolder5c22bb92c81ca408061144, $this, '__sleep', array(), $this->initializer5c22bb92c81d5190098851) || 1) && $this->valueHolder5c22bb92c81ca408061144 = $valueHolder5c22bb92c81ca408061144;

        return array('valueHolder5c22bb92c81ca408061144');
    }
    ...
    {
        return $this->initializer5c22bb92c81d5190098851;
    }
    ...
    {
        return $this->initializer5c22bb92c81d5190098851 && ($this->initializer5c22bb92c81d5190098851->__invoke($valueHolder5c22bb92c81ca408061144, $this, 'initializeProxy', array(), $this->initializer5c22bb92c81d5190098851) || 1) && $this->valueHolder5c22bb92c81ca408061144 = $valueHolder5c22bb92c81ca408061144;
    }
    ...
    {
        return null !== $this->valueHolder5c22bb92c81ca408061144;
    }
    ...
    {
        return $this->valueHolder5c22bb92c81ca408061144;
    }
