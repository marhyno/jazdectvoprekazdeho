...
(function () {
    ...
    google.maps.Load = function (apiLoad) {
        ...
        apiLoad([0.009999999776482582, [null, [
                    ["https://khms0.googleapis.com/kh?v=820\u0026hl=en-GB\u0026", "https://khms1.googleapis.com/kh?v=820\u0026hl=en-GB\u0026"], null, null, null, 1, "820", ["https://khms0.google.com/kh?v=820\u0026hl=en-GB\u0026", "https://khms1.google.com/kh?v=820\u0026hl=en-GB\u0026"]
                ], null, null, null, null, [
                    ["https://cbks0.googleapis.com/cbk?", "https://cbks1.googleapis.com/cbk?"]
                ],
                [
                    ["https://khms0.googleapis.com/kh?v=122\u0026hl=en-GB\u0026", "https://khms1.googleapis.com/kh?v=122\u0026hl=en-GB\u0026"], null, null, null, null, "122", ["https://khms0.google.com/kh?v=122\u0026hl=en-GB\u0026", "https://khms1.google.com/kh?v=122\u0026hl=en-GB\u0026"]
                ],
                [
            ...
            ["en-GB", "US", null, 0, null, null, "https://maps.gstatic.com/mapfiles/", null, "https://maps.googleapis.com", "https://maps.googleapis.com", null, "https://maps.google.com", null, "https://maps.gstatic.com/maps-api-v3/api/images/", "https://www.google.com/maps", 0, "https://www.google.com"],
            ["https://maps.googleapis.com/maps-api-v3/api/js/35/5/intl/en_gb", "3.35.5"],
            [277863236], null, null, null, null, null, null, "", null, null, 1, "https://khms.googleapis.com/mz?v=820\u0026", "AIzaSyBhOdIF3Y9382fqJYt5I_sswSrEw5eihAA", "https://earthbuilder.googleapis.com", "https://earthbuilder.googleapis.com", null, "https://mts.googleapis.com/maps/vt/icon", [
                ["https://maps.googleapis.com/maps/vt"],
                ["https://maps.googleapis.com/maps/vt"], null, null, null, null, null, null, null, null, null, null, ["https://www.google.com/maps/vt"], "/maps/vt", 447000000, 447
...
// inlined
(function (_) {
    var ta, va, za, Ba, Ca, Da, Ea, Ua, Va, gb, ob, pb, rb, tb, wb, yb, zb, Ab, Bb, Cb, Eb, Ib, Wb, Xb, Yb, $b, ec, gc, fc, pc, rc, sc, Hc, Jc, Nc, Uc, Wc, Xc, ad, id, kd, od, xd, yd, zd, Ad, Cd, Dd, Gd, Jd, Fd, Nd, Td, ce, de, he, ke, me, oe, ne, ue, we, ye, ze, xe, Be, Ee, Ge, He, Ae, De, Fe, Ie, Me, Ne, Oe, cf, df, ef, gf, hf, kf, lf, pf, qf, rf, sf, tf, vf, yf, zf, Hf, If, Jf, Lf, Qf, Tf, Zf, Vf, cg, bg, Xf, Rf, Of, qg, rg, sg, ug, vg, wg, xg, yg, Eg, Kg, Fg, Mg, Ig, Jg, Qg, Ng, Rg, Sg, Ug, Xg, Zg, Yg, ah, eh, hh, gh, kh, lh, mh, ph, qh, Ah, zh, rh, sh, Eh, ya, xa, Ia, Ha, Ra, Sa;
    _.aa = "ERROR";
    ...
    ke = function () {
        ...
        for (b = 1; 7 > b; ++b)
            ...
            if (b = /OS (?:X )?(\d+)[_.]?(\d+)/.exec(this.A)) this.B = new he((0, window.parseInt)(b[1], 10), (0, window.parseInt)(b[2] || "0", 10));
    ...
    _.S.prototype.set = function (a, b) {
        ...
        var d = Hc(c, a);
        if (d)
            if (a = d.wb, d = d.Yc, c = "set" + _.Id(a), d[c]) d[c](b);
            else d.set(a, b);
    ...
    */
    ...
    _.Ff.prototype.preventDefault = function () {
        ...
        else if (a.returnValue = !1, Ui) try {
    ...
    Jf.prototype.add = function (a, b, c, d, e) {
        ...
        var g = Lf(a, b, d, e); - 1 < g ? (b = a[g], c || (b.Wd = !1)) : (b = new Hf(b, this.src, f, !!d, e), b.Wd = c, a.push(b));
        return b
    };
    ...
    _.Sd(Sg.prototype, {
        map: _.Ci,
        tableId: _.qi,
        query: _.M(_.Sc([_.oi, _.Rc(_.Ec, "not an Object")]))
    });
    var $i = null;
    _.A(_.Tg, _.S);
